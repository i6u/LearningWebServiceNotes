 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "http://service.learn.zyr", wsdlLocation = "http://localhost:8080/um/services?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/um/services?wsdl");
