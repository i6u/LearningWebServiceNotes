 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "http://service.learn.zyr", wsdlLocation = "http://localhost:8080/wsfile/services?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICE_QNAME = new QName("http://service.learn.zyr", "UserService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/wsfile/services?wsdl");
    ...
    public IUserService getUserServicePort() {
        return super.getPort(new QName("http://service.learn.zyr", "UserServicePort"), IUserService.class);
    }
    ...
    public IUserService getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.learn.zyr", "UserServicePort"), IUserService.class, features);
    }
