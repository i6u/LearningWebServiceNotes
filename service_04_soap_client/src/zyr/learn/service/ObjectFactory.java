...
public class ObjectFactory {
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.learn.zyr/", name = "UserException")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.learn.zyr/", name = "authInfo")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.learn.zyr/", name = "list")
