 ...
 */
@WebServiceClient(name = "MyServiceImplService", targetNamespace = "http://service.learn.zyr/", wsdlLocation = "http://localhost:8888/ns?wsdl")
public class MyServiceImplService extends Service {
    ...
    private final static QName MYSERVICEIMPLSERVICE_QNAME = new QName("http://service.learn.zyr/", "MyServiceImplService");
    ...
    public IMyService getMyServiceImplPort() {
        return super.getPort(new QName("http://service.learn.zyr/", "MyServiceImplPort"), IMyService.class);
    }
    ...
    public IMyService getMyServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.learn.zyr/", "MyServiceImplPort"), IMyService.class, features);
    }
